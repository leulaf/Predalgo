...
const CreatePostScreen = ({navigation, route}) => {
   ...
   if(theme == 'light'){
       ...
       createMeme = <CreateMemeLight width={35} height={35} style={{ marginLeft: 10, marginRight: 5, marginTop:5}}/>;
       ...
       createMeme = <CreateMemeDark width={35} height={35} style={{ marginLeft: 10, marginRight: 5, marginTop:5}}/>;
