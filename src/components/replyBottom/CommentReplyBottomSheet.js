...
//         if(!once && replyImageToPost != ""){
//             console.log("handl------eBlur");
//             setOnce(true);
//             replyTextToPostRef.current.focus();
//             bottomSheetRef.current.snapToIndex(2);
//             // setCurrentIndex(2);
...
//         //     console.log(imageForPost);
//         //     setOnce(true);
//         //     console.log("handlesBlur");
//         //     Keyboard.dismiss();
//         //     bottomSheetRef.current.snapToIndex(0);
//         //     setCurrentIndex(0);
//         //     setTextInputInFocus(false);
//         // }else if(once && replyImageToPost == ""){
//         //     // setTextInputInFocus(true);
//         //     replyTextToPostRef.current.focus();
//         //     setTextInputInFocus(true);
//         // }
...
//                         style={[
//                             theme == 'light' ? 
//                                 (currentIndex == 1 || currentIndex == 2 || textInputInFocus ? 
//                                         replyImageToPost ? 
...
const CommentReplyBottomSheet = ({navigation, replyToPostId, replyToProfile, replyToUsername}) => {
    const {theme,setTheme} = useContext(ThemeContext);
    const {imageForPost, setImageForPost} = useContext(AuthenticatedUserContext);
    const [replyTextToPost, setReplyTextToPost] = useState("");
    const [replyImageToPost, setReplyImageToPost] = useState("");
