...
const SubCommentBottom = ({ replyToCommentId, commentId, likesCount, commentsCount }) => {
    ...
    const onLike = async () => {
        ...
        if (!likedSnapshot.exists()) {
          ...
          const commentRef = doc(db, 'subComments', replyToCommentId, "comments", commentId);
...
export default SubCommentBottom;
